<template>
    <div>
        <layout-main>
            ...
            <div v-if="datausers == null && errormessage !== null" class="alert alert-warning" role="alert">
                {{ errormessage }}
            </div>
            <div v-if="succesmessage !== null" class="alert alert-succes" role="alert">
                {{ succesmessage }}
            </div>
          ...
          createNewUser() {
              fetch("http://jsonplaceholder.typicode.com/users",
              {
                ...
                .then(json => {
                    ...
                    this.datausers = json;
                    this.succesmessage = "Data User Berhasil Disimpan!";
                }else{
